...
import {deleteRetrievalDateApi} from '../../../../../store/apis/admin'
import {showNotification} from '../../../components/notification'

export const RetrievalDateDeleteModal = () => {
  const {itemIdForDelete, setItemIdForDelete, fetchRetrievalDatesFunc} = useListView()
  ...
  const onDeleteHandler = () => {
    setLoading(true)
    deleteRetrievalDateApi({id: itemIdForDelete})
      .then((res) => {
        setLoading(false)
        ...
        <div className='modal-dialog modal-dialog-centered mw-450px'>
          ...
          <div className='modal-content'>
            <div className='modal-header'>
              {/* begin::Modal title */}
              <h2 className='fw-bolder fs-1'>Delete Retrieval Date</h2>
              {/* end::Modal title */}
