...
const UsersListFilter = () => {
  ...
  return (
    <>
      ...
      {/* begin::SubMenu */}
      <div
        className='menu menu-sub menu-sub-dropdown w-800px w-md-625px h-750px modal'
        data-kt-menu='true'
      >
        {/* begin::Header */}
              ...
              <div className='row mb-6'>
                ...
                <div className='col-lg-8 fv-row'>
                  <input
                    ...
                    onChange={(e) => {
                      setFilterData({...filterData, emptyDateStart: e.target.value})
                    }}
                  />
                </div>
              </div>
              ...
              <div className='row mb-6'>
                ...
                <div className='col-lg-8 fv-row'>
                  <input
                    ...
                    onChange={(e) => {
                      setFilterData({...filterData, checkinDateStart: e.target.value})
                    }}
                  />
                </div>
              </div>
              ...
              <div className='row mb-6'>
                ...
                <div className='col-lg-8 fv-row'>
                  <input
                    ...
                    onChange={(e) => {
                      setFilterData({...filterData, checkinDateEnd: e.target.value})
                    }}
                  />
                </div>
              </div>
                    ...
                    <label className='col-lg-4 form-check form-check-sm form-check-custom form-check-solid mb-5'>
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...filterData,
                            status: {...filterData.status, new: !filterData.status.new},
                          })
                        }}
                      />
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...
                            status: {
                              ...filterData.status,
                              inProgress: !filterData.status.inProgress,
                            },
                          })
                        }}
                      />
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...
                            status: {
                              ...filterData.status,
                              emptyDelivery: !filterData.status.emptyDelivery,
                            },
                          })
                        }}
                      />
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...
                            status: {
                              ...filterData.status,
                              schedCheckin: !filterData.status.schedCheckin,
                            },
                          })
                        }}
                      />
                    ...
                    <label className='col-lg-4 form-check form-check-sm form-check-custom form-check-solid mb-5'>
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...filterData,
                            status: {...filterData.status, checkin: !filterData.status.checkin},
                          })
                        }}
                      />
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...
                            status: {
                              ...filterData.status,
                              schedCheckout: !filterData.status.schedCheckout,
                            },
                          })
                        }}
                      />
                    ...
                    <label className='col-lg-4 form-check form-check-sm form-check-custom form-check-solid mb-5'>
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...filterData,
                            status: {...filterData.status, checkout: !filterData.status.checkout},
                          })
                        }}
                      />
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...
                            status: {
                              ...filterData.status,
                              schedEmptyReturn: !filterData.status.schedEmptyReturn,
                            },
                          })
                        }}
                      />
                    ...
                    <label className='col-lg-4 form-check form-check-sm form-check-custom form-check-solid mb-5'>
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...filterData,
                            status: {...filterData.status, completed: !filterData.status.completed},
                          })
                        }}
                      />
                    ...
                    <label className='col-lg-4 form-check form-check-sm form-check-custom form-check-solid mb-5'>
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...filterData,
                            status: {...filterData.status, hold: !filterData.status.hold},
                          })
                        }}
                      />
                    ...
                    <label className='col-lg-4 form-check form-check-sm form-check-custom form-check-solid mb-5'>
                      <input
                        ...
                        onChange={(e) => {
                          setFilterData({
                            ...filterData,
                            status: {...filterData.status, cancelled: !filterData.status.cancelled},
                          })
                        }}
                      />
