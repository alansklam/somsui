...
export const OrdersAddModalFormWrapper = () => {
  ...
  const initialValues =
    itemIdForUpdate == null
      ...
      : {
          emptyout_location_other:
            data[itemIdForUpdate].emptyout_location_other !== null
              ? data[itemIdForUpdate].emptyout_location_other
              : '',
          emptyout_date_other:
            data[itemIdForUpdate].emptyout_date_other !== null
              ? data[itemIdForUpdate].emptyout_date_other
              : '',
          emptyout_time_other:
            data[itemIdForUpdate].emptyout_time_other !== null
              ? data[itemIdForUpdate].emptyout_time_other
              : '',
          checkin_location_other:
            data[itemIdForUpdate].checkin_location_other !== null
              ? data[itemIdForUpdate].checkin_location_other
              : '',
          checkin_date_other:
            data[itemIdForUpdate].checkin_date_other !== null
              ? data[itemIdForUpdate].checkin_date_other
              : '',
          checkin_time_other:
            data[itemIdForUpdate].checkin_time_other !== null
              ? data[itemIdForUpdate].checkin_time_other
              : '',
          checkout_location_other:
            data[itemIdForUpdate].checkout_location_other !== null
              ? data[itemIdForUpdate].checkout_location_other
              : '',
          checkout_date_other:
            data[itemIdForUpdate].checkout_date_other !== null
              ? data[itemIdForUpdate].checkout_date_other
              : '',
          checkout_time_other:
            data[itemIdForUpdate].checkout_time_other !== null
              ? data[itemIdForUpdate].checkout_time_other
              : '',
          special_instruction:
            data[itemIdForUpdate].special_instruction !== null
              ? data[itemIdForUpdate].special_instruction
              : '',
                  ...
                  <div className='row mb-6'>
                    ...
                    <div className='col-lg-8 fv-row'>
                      <input
                        ...
                        placeholder='Code'
                        value={
                          itemIdForUpdate === undefined || itemIdForUpdate == null
                            ? ''
                            : data[itemIdForUpdate].code
                        }
                      />
                    </div>
                  </div>
                    ...
                    <div className='col-lg-8 fv-row'>
                      <input
                        ...
                        value={
                          itemIdForUpdate === undefined || itemIdForUpdate == null
                            ? ''
                            : data[itemIdForUpdate].client.name
                        }
                      />
                    </div>
                  </div>
                    ...
                    <div className='col-lg-8'>
                      <div className='input-group mb-3'>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setQuantity({...quantity, documentBox: e.target.value})
                          }}
                        />
                    ...
                    <div className='col-lg-8'>
                      <div className='input-group mb-3'>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setQuantity({...quantity, oversizeBox: e.target.value})
                          }}
                        />
                        <div className='input-group-append'>
                          <span
                    ...
                    <div className='col-lg-8'>
                      <div className='input-group mb-3'>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setQuantity({...quantity, wardrobeBox: e.target.value})
                          }}
                        />
                        <div className='input-group-append'>
                          <span
                  ...
                  <div className='row mb-6'>
                    ...
                    <div className='col-lg-8'>
                      <div className='input-group mb-3'>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setQuantity({...quantity, packageBox: e.target.value})
                          }}
                        />
                        <div className='input-group-append'>
                          <span
                    ...
                    <div className='col-lg-8 fv-row'>
                      <input
                        ...
                        onChange={(e) => {
                          setPrice({...price, packageBox: e.target.value})
                        }}
                      />
                    </div>
                  </div>
