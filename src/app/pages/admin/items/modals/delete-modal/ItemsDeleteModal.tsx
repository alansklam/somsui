...
import {deleteItemsApi} from '../../../../../store/apis/admin'
import {fetchProducts, fetchRef} from '../../../../../store/actions/admin'
import {useDispatch} from 'react-redux'
import {showNotification} from '../../../components/notification'

export const ItemsDeleteModal = () => {
  const {itemIdForDelete, setItemIdForDelete, fetchItemsFunc} = useListView()
  ...
  const onDeleteHandler = () => {
    setLoading(true)
    deleteItemsApi({id: itemIdForDelete})
      .then((res) => {
        setLoading(false)
      ...
      .catch((err) => {
        showNotification('error', 'Error', 'Deleted successfully.')
      })
  }
        ...
        <div className='modal-dialog modal-dialog-centered mw-450px'>
          ...
          <div className='modal-content'>
            <div className='modal-header'>
              {/* begin::Modal title */}
              <h2 className='fw-bolder fs-1'>Items</h2>
              {/* end::Modal title */}
