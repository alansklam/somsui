  ...
  const submitPromotionItem = (e: any) => {
    ...
    itemIdForUpdate !== null &&
      editPromotionItemApi({
        data: price,
        id: itemIdForUpdate !== undefined ? data[itemIdForUpdate].id : '',
      })
        .then((res) => {
          setLoading(false)
          fetchPromotionFunc()
  ...
  const initialValues =
    itemIdForUpdate == null
      ...
      : {
          ...
          effective_from: data[itemIdForUpdate].effective_from
            ? dayjs(data[itemIdForUpdate].effective_from).format('YYYY-MM-DD')
            : undefined,
          effective_to: data[itemIdForUpdate].effective_to
            ? dayjs(data[itemIdForUpdate].effective_to).format('YYYY-MM-DD')
            : undefined,
        }
                    ...
                    <div className='row mb-6'>
                      ...
                      <div className='col-lg-12 fv-row'>
                        <input
                          ...
                          onChange={(e) => {
                            setPrice({...price, overisizeBox: e.target.value})
                          }}
                        />
                      </div>
                    </div>
