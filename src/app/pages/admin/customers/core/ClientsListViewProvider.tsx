...
const ClientsListViewProvider: FC<WithChildren> = ({children}) => {
  ...
  const data = useSelector((state: RootState) => state.admin.clients.data)
  const page = useSelector((state: RootState) => state.admin.clients.pagination)
  const filter = useSelector((state: RootState) => state.admin.clients.filterData)
