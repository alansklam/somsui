...
export default function ContentPage3(props) {
  ...
  useEffect(() => {
    if (initial) {
      ...
      setMobile(__stuffInfo.mobile ? __stuffInfo.mobile : '')
      ...
      setLadenReturnTimeIndex(
        __stuffInfo.ladenReturnTimeIndex ? __stuffInfo.ladenReturnTimeIndex : 0
      )
      //   setTentativeTimeIndex(__stuffInfo.tentativeTimeIndex ? __stuffInfo.tentativeTimeIndex : 0)

      stuffInfo.deliveryDate === undefined &&
        setStuffInfo({
          name: '',
          email: '',
          contact: '',
  ...
  const onNextHandler = () => {
    ...
    if (email === '') {
      ...
      if (__result == null) {
        onNotification({
          title: 'warning',
          message: 'common.no-input-email-validate',
          visible: true,
          status: Math.floor(Math.random() * 100000),
        })
        return
    ...
    if (email.length > 100) {
      onNotification({
        title: 'warning',
        message: 'common.no-input-email-length',
        visible: true,
        status: Math.floor(Math.random() * 100000),
      })
      return
    ...
    //  onNotification({
    //    title: 'warning',
    //    message: 'common.no-input-mobile',
    //    visible: true,
    //    status: Math.floor(Math.random() * 100000),
    //  })
    //  return
    ...
    if (address === '') {
      onNotification({
        title: 'warning',
        message: 'common.no-input-address',
        visible: true,
        status: Math.floor(Math.random() * 100000),
      })
      return
      ...
      onNotification({
        title: 'warning',
        message: 'common.no-input-address-length',
        visible: true,
        status: Math.floor(Math.random() * 100000),
      })
      return
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6} md={6}>
                  <CssTextField
                    ...
                    onBlur={(e) => {
                      setStuffInfo({...stuffInfo, mobile: e.target.value})
                      // let __contact = e.target.value;
                      // let __re = /[^0-9]+/g;
                      // let __result = __contact.match(__re);
                      // let __length = __contact.length;
