...
export default function ContentPage1(props) {
  ...
  return (
    <div>
          ...
          <div className='product'>
            ...
            <div className='ml-[40px] mr-[40px] mb-[40px]'>
              <div className='text-header'>
                {i18n.language === 'zh' ? selectedItem?.item.name_cn : selectedItem?.item.name}
              </div>
              <div className='product-modal-content'>
                <div className='image-area flex mx-[20px] my-[20px] align-items-center product-modal-img'>
                  <img
                    src={selectedItem?.item.uri}
                    alt='product'
                    width={90}
                    height={90}
                    onClick={(e) => {
                ...
                <div className='product-modal-des'>
                  ...
                  <div className='text-header-400 ml-[15px]'>
                    {i18n.language === 'zh'
                      ? selectedItem?.item.description_cn
          ...
          <Grid container spacing={0} className='mt-[36px]'>
            <Grid item xs={12} sm={4} md={4}>
              <div className='flex item-center'>
                <NumberInput className='mx-[14px]' value={duration} onChange={() => {}} />
            ...
            <Grid item xs={12} sm={8} md={8} className='my-auto'>
              <div className='flex my-auto w-[100%] xs:mt-[20px]'>
                <Slider
                  ...
                  onChangeCommitted={changeSliderStatus}
                />
              </div>
            </Grid>
          </Grid>
          <div className='spin-line' />
          <div className='text-header text-black mt-[37px] mb-[17px]'>
            {t('page1.qu-what-store')}
          </div>
          <div>
            {props.items &&
                ...
                return (
                  <div className='mt-[25px]' key={index}>
                    <div className='row align-items-center item-center' key={index}>
                      <div
                        className='col-sm-3 col-6 min-w-[120px] py-[20px]'
                        style={{zIndex: '100'}}
                      >
                        <Quantity
                          value={
                            props.selectedItems && props.selectedItems[item.id]
                              ? props.selectedItems[item.id].count
                              : 0
                          }
                          item={item}
                          key={index}
                      ...
                      <div className='col-sm-9 col-6'>
                        <div className='row align-items-center'>
                          ...
                          <div className='col-sm-8 col-12 my-auto product-des'>
                            <div
                              className='text-normal hand product-des-name'
                              onClick={(e) => {
                                openDialog({item})
                              }}
                            >
                              <u>{i18n.language === 'zh' ? item.name_cn : item.name}</u>
                            </div>
                            <div className='text-small product-des-detail'>
                              {i18n.language === 'zh' ? item.description_cn : item.description}
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className='flex item-center mt-[35px]'>
