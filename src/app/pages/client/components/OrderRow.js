        ...
        <tr key={index}>
          <td key={'order' + index}>
            <Link
              ...
              id={'link' + index}
              className='text-dark fw-bold order-no-color fs-5'
            >
              {order.code}
            </Link>
          </td>
          <td key={index + '-status'} className='text-center'>
            <span
              className={'fs-7 min-w-[80px] badge ' + getStatusColor(order)}
          ...
          <td className='text-dark fw-bold  fs-5' key={index + '-total'}>
            {'$' + order.total_fee}
          </td>
          <td className='text-dark fw-bold fs-5' key={index + '-balance'}>
            ${getBalance(order.balance)}
          </td>
