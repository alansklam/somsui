    ...
    <>
      <div className='header'>
        <div className='content mx-auto row flex justify-content-around'>
          <div
            className={(props.children ? 'width-logo' : 'w-[50%]') + ' flex align-items-center '}
          >
            <div className='pl-[20px] '>
              <img
                src='/images/ubox-logo.png'
                className='link'
                alt='uBox Logo'
                width={250}
                height={100}
          ...
          <div
            className={
              (props.children ? 'col-md-6' : 'd-none') +
              ' header-container my-auto pl-[20px] flex justify-content-center'
            }
          >
            {props.children}
          </div>
          <div
            className={
              (props.children ? 'width-link' : 'w-[50%]') +
          ...
          >
                ...
                <div className='language my-auto flex [90px]'>
                  <div>
                    <img
                      ...
                      className={`${language === 'en' ? 'active link' : 'link'}`}
                      alt='English Logo'
                  ...
                  <div>
                    <img
                      src='/images/lang_zh.png'
                      className={`${language === 'zh' ? 'active link ' : 'link '}`}
                      alt='Chinese Logo'
                      style={{width: '38px', height: 'auto'}}
                      onClick={(e) => {
                        onChangeLanguage('zh')
                ...
                {logged === 1 ? (
                  <>
                    <div className='pr-[20px] pl-[20px] py-[10px] min-w-[90] flex align-items-center'>
                      <span
                        onClick={onMyOrderHandler}
                        rel='noreferrer'
                        className='text-header text-yellow contact link'
                      >
                        {t('common.wd-my-order')}
                      </span>
                    </div>
            ...
            <div className='flex justify-content-end flex-wrap align-content-around padding-link'>
              <div className='flex pr-[20px]'></div>
            </div>
          </div>
        </div>
      </div>
