  ...
  return (
    <div className='cart-container min-w-[270px]'>
      <div className='content'>
        ...
        <AccountTextField title={t('common.wd-mobile-cn-no')} content={user.mobile_phone_cn} />
        ...
        <div className='py-[10px]'>
          <Link to='/client/dashboard' className='text-header text-blue'>
            {t('common.wd-my-order')}
          </Link>
        </div>
        <div className='flex item-center my-[30px]'>
          <Link to='client/account' className='custom-btn hand text-normal-18'>
            {t('common.wd-edit')}
          </Link>
        </div>
      </div>
